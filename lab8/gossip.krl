ruleset gossip {
    meta {
        ...
        shares tempLogs, myHighestSeenSequences, peersStates, peers, sensorId
        provides sensorId
    }
    ...
    global {
        ...
        prepareRumorMessage = function(peer) {
            ...
            ent:tempLogs{[neededPeer, messageId]}
        }
    ...
    rule gossip_compare_seen {
        ...
        foreach myHighestSeenSequences().keys() setting(sensorId)
            pre {
                ...
                seenMessages = event:attrs{"message"}
                highestSequenceId = seenMessages{sensorId}
    ...
    rule send_missing_message {
        ...
        pre {
            ...
            message = ent:tempLogs{[sensorId, messageId]}.klog("message: ")
        }
